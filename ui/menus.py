...
def draw_start_menu(surface: pygame.Surface, mouse_pos: tuple[int, int] | None = None) -> dict[str, pygame.Rect]:
    ...
    btn_w, btn_h = 220, 44
    select_level_rect = pygame.Rect(w // 2 - btn_w // 2, h // 2 + 80, btn_w, btn_h)
...
def draw_level_select_menu(
    ...
    try:
        import pygame.freetype as ft
        font_title = ft.Font(None, 48)
        font_level = ft.Font(None, 32)
